...
public class TesteAvaliaWifiService {
    public static void main(String[] args) {
        ...
        medicoes1.add(new Medicao(1L, LocalDateTime.now(), -48, 90.0, "Sem interferência", sala1, residencia1));
        medicoes1.add(new Medicao(2L, LocalDateTime.now(), -65, 40.0, "Pouca interferência", quarto1, residencia1));
        ...
        // Residência 2
        Residencia residencia2 = new Residencia(2L, "Residência Secundária", "Av. Central, 456");
        ...
        medicoes2.add(new Medicao(3L, LocalDateTime.now(), -72, 15.0, "Muita interferência", cozinha2, residencia2));
        medicoes2.add(new Medicao(4L, LocalDateTime.now(), -78, 10.0, "Muita interferência", escritorio2, residencia2));
